...
+ Open a previous markdown file and copy its contents across. Go back to the [file for July]([here](https://github.com/EdinbR/EdinbR.github.io/blob/master/_posts/2015-07-08-july-meeting.markdown)) for example, click the *pencil* edit icon and copy-paste the full post to your new file.
